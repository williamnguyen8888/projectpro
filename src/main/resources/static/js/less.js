...
!function (a, b) {
    ...
    function f(a, c) {
        var e = "{line} {content}", f = a.filename || c, g = [],
    ...
    function g(a, b, c) {
        var f = b.href || "", g = "less:" + (b.title || e(f)), h = document.getElementById(g), i = !1,
    ...
    function i(a, c) {
        var d, f, h = "less-error-message:" + e(c || ""),
            i = '<li><label>{line}</label><pre class="{class}">{content}</pre></li>', j = document.createElement("div"),
            k = [], l = a.filename || c, m = l.match(/([^\/]+(\?.*)?)$/)[1];
    ...
    w === b && (w = exports, x = c("./tree"), w.mode = "node"), w.Parser = function (a) {
        ...
        function u(a, b) {
            var c = r(a, b), d = s(a.index, c), e = d.line, f = d.column, g = a.call && s(a.call, c).line,
                h = c.split("\n");
        ...
        return u.prototype = new Error, u.prototype.constructor = u, this.env = a = a || {}, this.optimization = "optimization" in this.env ? this.env.optimization : 1, E = {
            imports: I, parse: function (d, e, f) {
                ...
                primary: function () {
                    ...
                    call: function () {
                        ...
                        var b, c, g, h, i, l, m = E.parsers, n = m.entities, p = {args: null, variadic: !1}, q = [],
                            r = [], s = [];
                        for (d(); ;) {
        ...
        d.functions = {
            rgb: function (a, b, c) {
                ...
                var e = c.value / 100, f = 2 * e - 1, g = a.toHSL().a - b.toHSL().a,
                    h = ((f * g == -1 ? f : (f + g) / (1 + f * g)) + 1) / 2, i = 1 - h,
                ...
                var f, g, h, i, j, k, l, m = Array.prototype.slice.call(arguments, 1), n = "linear",
                    o = 'x="0" y="0" width="1" height="1"', p = !0, q = {compress: !1}, r = a.toCSS(q);
                switch (r) {
                    case"to bottom":
        ...
        a.mixin = {}, a.mixin.Call = function (b, c, d, e, f) {
            ...
            type: "MixinCall", accept: function (a) {
                ...
                var c, d, e, f, g, h, i, j, k, l, m, n, o = [], p = !1, q = [], r = [], s = a.defaultFunc, t = 0, u = 1,
                    v = 2;
            ...
            type: "MixinDefinition", accept: function (a) {
                ...
                var e, f, g = [], h = this.frames ? this.frames.concat(b.frames) : b.frames,
        ...
        a.visitor = function (b) {
            ...
            visit: function (a) {
                ...
                var c = a.typeIndex;
                if (!c) return a;
                var e, f = this._visitFnCache, g = this._implementation, h = c << 1, i = 1 | h, j = f[h], k = f[i],
                    l = d;
